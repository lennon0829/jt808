...
public class CarRuntime {
	...
	public String getCarPassport() {
		return carPassport;
	}

	
	public void setCarPassport(String carPassport) {
		this.carPassport = carPassport;
	}
	...
	public BigDecimal getGpsPosX() {
		return gpsPosX;
	}

	
	public void setGpsPosX(BigDecimal gpsPosX) {
		this.gpsPosX = gpsPosX;
	}

	
	public BigDecimal getGpsPosY() {
		return gpsPosY;
	}

	
	public void setGpsPosY(BigDecimal gpsPosY) {
